...
import Description from "./components/mark_six/description/index.vue";
import FastDisk from "./components/mark_six/special_code/fast_disk/index.vue";
import SpecialGeneralDisk from "./components/mark_six/special_code/general_disk/index.vue";
import MainGeneralDisk from "./components/mark_six/main_code/general_disk/index.vue";
import MainSpecialGeneralDisk from "./components/mark_six/main_special_code/general_disk/index.vue";
import Main1_6GeneralDisk from "./components/mark_six/main_code_1_6/general_disk/index.vue";
import LotteryParlayDisk from "./components/mark_six/lottery_parlay/index.vue";
import EvenCodeDisk from "./components/mark_six/even_code/index.vue";
import HalfWaveDisk from "./components/mark_six/half_wave/index.vue";
import OneXiaoDisk from "./components/mark_six/onexiao_mantissa/one_xiao.vue";
import MantissaDisk from "./components/mark_six/onexiao_mantissa/mantissa.vue";
import SpecialZodiacDisk from "./components/mark_six/special_zodiac/index.vue";
import CompatibleDisk from "./components/mark_six/compatible_code/index.vue";
import ZodaicEvenDisk from "./components/mark_six/zodiac_even/index.vue";
import MantissaEvenDisk from "./components/mark_six/mantissa_even/index.vue";
import MissAllDisk from "./components/mark_six/miss_all/index.vue";
...
const { dispatchGameVersion } = katanStore();
const { dispatchGameResult } = katanStore();
const { dispatchEvenLotteryBet } = katanStore();
const { dispatchCompatibleLotteryBet } = katanStore();
const { dispatchZodaicEvenLotteryBet } = katanStore();
const { dispatchMantissaEvenLotteryBet } = katanStore();
const { dispatchMissAllLotteryBet } = katanStore();
...
const descriptionTitle = ref("香港六合彩游戏规则");
...
const orderNumber = computed(() => {
  const { getOrderNumber } = storeToRefs(katanStore());
...
const gameVersion = computed(() => {
  const { getGameVersion } = storeToRefs(katanStore());
  return getGameVersion.value;
});
const gameResult = computed(() => {
  const { getGameResult } = storeToRefs(katanStore());
  return getGameResult.value;
});
const gameStatus = computed(() => {
  const { getGameStatus } = storeToRefs(katanStore());
...
const success = computed(() => {
  const { getSuccess } = storeToRefs(katanStore());
  return getSuccess.value;
});
const errMessage = computed(() => {
  const { getErrMessage } = storeToRefs(katanStore());

<template>
	<div>
		<div class="game-list" v-for="(item, index) in changedFTDataList" :key="index">
			...
			<div class="center-item" :class="{ detail_show: item['show'], detail_hide: !item['show'] }"
				...
				<div class="table-text table-list" v-for="(datalist, scoreIndex) in data.scoreList" :key="scoreIndex">
					...
					<div class="table-text-r" v-for="(num, index) in datalist.nums" :key="index">
						<div v-if="num.type == 1" @click="handleModal(item, data, datalist, num, scoreIndex)"
		...
		<OrderModal v-if="openModal" :type="type" :title="title" :m_team="m_team" :t_team="t_team" :league="league"
			:rate="rate" :select_team="select_team" @close="closeModal" />
	</div>
</template>
<script lang="ts">
...
export default defineComponent({
		...
		receivedFTInPlayData(data: any) {
			...
			for (let i = 0; i < totalCount; i++) {
				...
				for (let j = 0; j < subCount; j++) {
					...
					if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][0].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][0].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][0].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][0].colorChangeUp = true;
					}
					if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][1].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][1].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][1].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][1].colorChangeUp = true;
					}
					if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][2].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][2].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][2].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][2].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][2].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][2].colorChangeUp = true;
					}
					if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][3].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][3].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][3].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][3].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][3].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][0]["nums"][3].colorChangeUp = true;
					}

					if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][0].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][0].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][0].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][0].colorChangeUp = true;
					}
					if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][1].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][1].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][1].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][1].colorChangeUp = true;
					}
					if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][2].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][2].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][2].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][2].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][2].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][2].colorChangeUp = true;
					}
					if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][3].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][3].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][3].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][3].num - this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][3].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["cornerList"][1]["nums"][3].colorChangeUp = true;
					}


					if ((this.tempFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][0].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][0].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][0].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][0].colorChangeUp = true;
					}
					if ((this.tempFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][1].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][1].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][1].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][0]["nums"][1].colorChangeUp = true;
					}

					if ((this.tempFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][0].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][0].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][0].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][0].colorChangeUp = true;
					}
					if ((this.tempFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][1].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][1].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][1].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt1"]["data"][1]["nums"][1].colorChangeUp = true;
					}

					if ((this.tempFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][0].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][0].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][0].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][0].colorChangeUp = true;
					}
					if ((this.tempFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][1].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][1].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][1].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][0]["nums"][1].colorChangeUp = true;
					}

					if ((this.tempFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][0].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][0].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][0].num - this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][0].num) < 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][0].colorChangeUp = true;
					}
					if ((this.tempFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][1].num) > 0) {
						this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][1].colorChangeDown = true;
					} else if ((this.tempFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][1].num - this.changedFTDataList[i]["gameList"][j]["fullCourt2"]["data"][1]["nums"][1].num) < 0) {
	...
	methods: {
									...
									nums: [
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item["RATIO_RE_HDP_0"] != "" && (Number(item["IOR_REH_HDP_0"])) > (Number(item["IOR_REC_HDP_0"])) ? "-" + item["RATIO_RE_HDP_0"] : "+" + item["RATIO_RE_HDP_0"],
											num: (Number(item["IOR_REH_HDP_0"])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item["RATIO_RE_HDP_1"],
											num: (Number(item["IOR_REH_HDP_1"])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item["RATIO_RE_HDP_2"],
											num: (Number(item["IOR_REH_HDP_2"])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item["RATIO_RE_HDP_3"],
											num: (Number(item["IOR_REH_HDP_3"])).toFixed(2)
										},
									]
								},
								{
									...
									nums: [
										{
											...
											colorChangeDOwn: false,
											text: item["RATIO_RE_HDP_0"] != "" && (Number(item["IOR_REH_HDP_0"])) < (Number(item["IOR_REC_HDP_0"])) ? "-" + item["RATIO_RE_HDP_0"] : "+" + item["RATIO_RE_HDP_0"],
											num: (Number(item["IOR_REC_HDP_0"])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: "-" + item["RATIO_RE_HDP_1"],
											num: (Number(item["IOR_REC_HDP_1"])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: "-" + item["RATIO_RE_HDP_2"],
											num: (Number(item["IOR_REC_HDP_2"])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: "-" + item["RATIO_RE_HDP_3"],
											num: (Number(item["IOR_REC_HDP_3"])).toFixed(2)
										},
									]
								}
							]
									...
									nums: [
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item['RATIO_ROUO_HDP_0'],
											num: (Number(item['IOR_ROUC_HDP_0'])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item['RATIO_ROUO_HDP_1'],
											num: (Number(item['IOR_ROUC_HDP_1'])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item['RATIO_ROUO_HDP_2'],
											num: (Number(item['IOR_ROUC_HDP_2'])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item['RATIO_ROUO_HDP_3'],
											num: (Number(item['IOR_ROUC_HDP_3'])).toFixed(2)
										},
									]
								},
								{
									...
									nums: [
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item['RATIO_ROUU_HDP_0'],
											num: (Number(item['IOR_ROUH_HDP_0'])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item['RATIO_ROUU_HDP_1'],
											num: (Number(item['IOR_ROUH_HDP_1'])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item['RATIO_ROUU_HDP_2'],
											num: (Number(item['IOR_ROUH_HDP_2'])).toFixed(2)
										},
										{
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item['RATIO_ROUU_HDP_3'],
											num: (Number(item['IOR_ROUH_HDP_3'])).toFixed(2)
										},
									]
								}
							]
						...
						cornerList: [
							{
								...
								nums: [
									{
										type: item["IOR_ROUC_CN"] == 0 ? 2 : 1,
										colorChangeUp: false,
										colorChangeDOwn: false,
										text: "大" + item["RATIO_ROUO_CN"].split("O")[1],
										num: item["IOR_ROUC_CN"] == 0 ? 0 : (Number(item["IOR_ROUC_CN"])).toFixed(2)
									},
									{
										type: item["IOR_REOE_CN"] == 0 ? 2 : 1,
										colorChangeUp: false,
										colorChangeDOwn: false,
										text: "单",
										num: item["IOR_REOE_CN"] == 0 ? 0 : (Number(item['IOR_REOE_CN'])).toFixed(2)
									},
									{
										type: item["IOR_HROUC_CN"] == 0 ? 2 : 1,
										colorChangeUp: false,
										colorChangeDOwn: false,
										text: "大" + item["RATIO_HROUO_CN"].split("O")[1],
										num: item["IOR_HROUC_CN"] == 0 ? 0 : (Number(item["IOR_HROUC_CN"])).toFixed(2)
									},
									{
										type: item["IOR_HREOE_CN"] == 0 ? 2 : 1,
										colorChangeUp: false,
										colorChangeDOwn: false,
										text: '单',
										num: item["IOR_HREOE_CN"] == 0 ? 0 : Number(item['IOR_HREOE_CN']).toFixed(2)
									}
								]
							},
							{
								...
								nums: [
									{
										type: item["IOR_ROUH_CN"] == 0 ? 2 : 1,
										colorChangeUp: false,
										colorChangeDOwn: false,
										text: "小" + item["RATIO_ROUU_CN"].split("U")[1],
										num: item["IOR_ROUH_CN"] == 0 ? 0 : (Number(item["IOR_ROUH_CN"])).toFixed(2)
									},
									{
										type: item["IOR_REOO_CN"] == 0 ? 2 : 1,
										colorChangeUp: false,
										colorChangeDOwn: false,
										text: "双",
										num: item["IOR_REOO_CN"] == 0 ? 0 : (Number(item['IOR_REOO_CN'])).toFixed(2)
									},
									{
										type: item["IOR_HROUH_CN"] == 0 ? 2 : 1,
										colorChangeUp: false,
										colorChangeDOwn: false,
										text: "小" + item["RATIO_HROUU_CN"].split("U")[1],
										num: item["IOR_HROUH_CN"] == 0 ? 0 : Number(item["IOR_HROUH_CN"]).toFixed(2)
									},
									{
										type: item["IOR_HREOO_CN"] == 0 ? 2 : 1,
										colorChangeUp: false,
										colorChangeDOwn: false,
										text: '双',
										num: item["IOR_HREOO_CN"] == 0 ? 0 : Number(item['IOR_HREOO_CN']).toFixed(2)
									}
								]
							},
						],
		...
		handleCornerModal: function (leagueData, gameData, dataList, rateData, scoreIndex) {
			this.m_team = gameData.cornerList[0].name;
			this.t_team = gameData.cornerList[1].name;
			this.league = leagueData.name;
			this.title = this.cornerTitleList[scoreIndex + 1][0] + this.cornerTitleList[scoreIndex + 1][1];
			this.rate = rateData.num;
			this.select_team = dataList.name
			if (this.rate == 0 || this.rate == null) this.openModal = false;
			else this.openModal = true;
		...
		handleSummaryModal1: function (leagueData, gameData, title, dataList, rateData) {
			console.log("22222222222222222222222222", dataList);
			this.m_team = gameData.scoreList[0].name;
			this.t_team = gameData.scoreList[1].name;
			this.rate = rateData.num;
			this.league = leagueData.name;

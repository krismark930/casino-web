...
watch(lotteryOddsList, () => {
    lotteryOddsList.value.map((item: any) => {
        if (item.sub_type == "总和龙虎和") {
            dragon_tiger_list.value[0].rate = item.h0;
            dragon_tiger_list.value[1].rate = item.h1;
            dragon_tiger_list.value[2].rate = item.h2;
            dragon_tiger_list.value[3].rate = item.h3;
            dragon_tiger_list.value[4].rate = item.h4;
            dragon_tiger_list.value[5].rate = item.h5;
            dragon_tiger_list.value[6].rate = item.h6;
        }
    })
})

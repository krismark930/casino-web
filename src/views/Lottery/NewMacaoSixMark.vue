...
import Description from "./components/new_macao_mark_six/description/index.vue";
import FastDisk from "./components/new_macao_mark_six/special_code/fast_disk/index.vue";
import SpecialGeneralDisk from "./components/new_macao_mark_six/special_code/general_disk/index.vue";
import MainGeneralDisk from "./components/new_macao_mark_six/main_code/general_disk/index.vue";
import MainSpecialGeneralDisk from "./components/new_macao_mark_six/main_special_code/general_disk/index.vue";
import Main1_6GeneralDisk from "./components/new_macao_mark_six/main_code_1_6/general_disk/index.vue";
import LotteryParlayDisk from "./components/new_macao_mark_six/lottery_parlay/index.vue";
import EvenCodeDisk from "./components/new_macao_mark_six/even_code/index.vue";
import HalfWaveDisk from "./components/new_macao_mark_six/half_wave/index.vue";
import OneXiaoDisk from "./components/new_macao_mark_six/onexiao_mantissa/one_xiao.vue";
import MantissaDisk from "./components/new_macao_mark_six/onexiao_mantissa/mantissa.vue";
import SpecialZodiacDisk from "./components/new_macao_mark_six/special_zodiac/index.vue";
import CompatibleDisk from "./components/new_macao_mark_six/compatible_code/index.vue";
import ZodaicEvenDisk from "./components/new_macao_mark_six/zodiac_even/index.vue";
import MantissaEvenDisk from "./components/new_macao_mark_six/mantissa_even/index.vue";
import MissAllDisk from "./components/new_macao_mark_six/miss_all/index.vue";

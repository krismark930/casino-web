...
watch(lotteryOddsList, () => {
    lotteryOddsList.value.map((item: any) => {
        if (item.sub_type == "顺子杂六" && item.ball_type == "ball_1") {
            top_list.value[0].rate = item.h1;
            top_list.value[1].rate = item.h2;
            top_list.value[2].rate = item.h3;
        }
        if (item.sub_type == "顺子杂六" && item.ball_type == "ball_2") {
            middle_list.value[0].rate = item.h1;
            middle_list.value[1].rate = item.h2;
            middle_list.value[2].rate = item.h3;
        }
        if (item.sub_type == "顺子杂六" && item.ball_type == "ball_3") {
            after_list.value[0].rate = item.h1;
            after_list.value[1].rate = item.h2;
            after_list.value[2].rate = item.h3;
        }
    })
})

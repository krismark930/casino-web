...
export default defineComponent({
	...
	data() {
		return {
			...
			changedBKDataList: [] as Array<any>,
			tempBKDataList: [] as Array<any>,
		}
	},
	sockets: {
		connect: function () {
		...
		receivedBKEarlyMessage: function (data: any) {
			this.loading = false;
	...
	methods: {
		saveFavorite: function (lid: any, id: any, ecid: any) {
			console.log(lid);
	...
	mounted() {
		...
		this.$socket.emit("sendBKEarlyMessage", { lids: this.earlyGids, field: this.field });
	},
	unmounted() {
		this.$socket.emit("stopBKEarlyMessage");
	}
})
</script>

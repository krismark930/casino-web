								...
								},
								{
									...
									nums: [
										...
										},
										{
											...
											colorChangeUp: false,
											colorChangeDOwn: false,
											text: item["TG_Dime_3"] == "" || item["TG_Dime_3"] == undefined ? "" : item["TG_Dime_3"].toString().split("U") ? "小 " + item["TG_Dime_3"].toString().split("U")[1] : "小 " + item["TG_Dime_3"].toString(),
						...
						scoreList: [
							{
								...
								nums: [
									...
									},
									{
										...
										colorChangeUp: false,
										colorChangeDOwn: false,
										text: item["MB_Dime"] == "" ? "" : item["MB_Dime"].toString().includes("O") ? "大 " + item["MB_Dime"].toString().split("O")[1] : "大 " + item["MB_Dime"].toString(),
							...
							},
							{
								...
								nums: [
									...
									},
									{
										...
										colorChangeUp: false,
										colorChangeDOwn: false,
										text: item["TG_Dime"] == "" ? "" : item["TG_Dime"].toString().includes("U") ? "小 " + item["TG_Dime"].toString().split("U")[1] : "小 " + item["TG_Dime"].toString(),

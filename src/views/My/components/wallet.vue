...
<template>
    <div
        class="shadow-[0_0px_10px_-1px_rgba(0,0,0,0.3)] m-1 rounded-sm px-2 pt-[15px] pb-[7px] flex justify-between"
            >
                <div class="">
                    <div class="text-[14px] text-[#7A7A7A]" v-if="user.id != undefined">{{user.UserMoney}}</div>
                </div>

    ...
    <div class="animated fadeInLeft">
        ...
        <div class="pt-[47px] pb-[60px] h-screen  bg-gray-100 text-[15px]">
                    ...
                    <div class="px-2 pt-[15px] relative z-10">
                        ...
                        <div class="flex justify-between items-center mt-[17px] px-1">
                            ...
                            <div class="w-full flex justify-around  px-1">
                                <div v-for="(item, index) in headerNumberList" :key="index" :style="{ 'background-color': item.color}" class="rounded-sm w-[18px] h-[20px] flex items-center justify-center">
                                    {{ item.value }}
                                </div>
                            </div>
            ...
            <div v-if="mainActive === true">
                <div class="relative  flex justify-between mt-[18px] bg-white h-[37px] px-2 text-[12px]">
                    <div class="flex">
                ...
                <div class="flex bg-white ml-[150px] h-full text-[11px] text-gray-600">
                    <div class="px-1 w-full py-[5px]">
                        ...
                        <div class="flex py-1 grid grid-cols-3">
                            ...
                            :class="[trendButtonActive === 1? 'bg-[#2674ff] text-white':'bg-[#e8f6ff] text-black']" class="bg-blue-200 px-[6px] py-[4px] rounded-sm  mr-1 border-blue-300 border">
                                开奖号码
                            </button>
                        </div>
                        ...
                        <div class="flex py-1 grid grid-cols-3">
                            ...
                            :class="[trendButtonActive === 2? 'bg-[#2674ff] text-white':'bg-[#e8f6ff] text-black']" class="bg-blue-200 px-[6px] py-[4px] rounded-sm  mr-1 border-blue-300 border">
                                大小单双
                            </button>
                            <button
                            @click="selectTrendButton(3)"
                            :class="[trendButtonActive === 3? 'bg-[#2674ff] text-white':'bg-[#e8f6ff] text-black']" class="bg-blue-200 px-[6px] py-[4px] rounded-sm  mr-1 border-blue-300 border">
                                龙虎
                            </button>
                            <button
                            @click="selectTrendButton(4)"
                            :class="[trendButtonActive === 4? 'bg-[#2674ff] text-white':'bg-[#e8f6ff] text-black']" class="bg-blue-200 px-[6px] py-[4px] rounded-sm  mr-1 border-blue-300 border">
                                和值
                            </button>
                        </div>
                    </div>
...
import DoubleSideDisk from './components/PK10/DoubleSideDisk.vue';
import StandardDisk from './components/PK10/StandardDisk.vue';
import Trend from './components/PK10/Trend.vue';
